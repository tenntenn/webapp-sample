...
// an implement of goweb.RestReader
func (c *Controller) Read(id string, gowebContext *goweb.Context) {

	r := gowebContext.Request
...
// an implement of goweb.RestUpdater
func (c *Controller) Update(id string, gowebContext *goweb.Context) {
		c := appengine.NewContext(r)
